...
import { MemoryRouter, Routes, Route, createMemoryRouter, createRoutesFromElements } from 'react-router-dom'
    ...
    it('log in with loader and navigate to dashboard', () => {
        ...
        const router = createMemoryRouter(
            createRoutesFromElements(
                <>
                    <Route path='/login' element={<Login />} loader={redirectIfAuthed} />
